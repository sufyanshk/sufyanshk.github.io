...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include video.html path="assets/img/1_project/shearingVideo.mp4" title="Shearing video" class="img-fluid rounded z-depth-1" autoplay loop %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include video.html path="assets/img/1_project/faultRelaxation.mp4" title="Shearing relaxation" class="img-fluid rounded z-depth-1" autoplay loop %}
    </div>
</div>
<div class="caption">
