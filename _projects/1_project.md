...
Here, the $$E_{faulted}$$ is the energy of supercell having a stacking fault and the $$E_{pristine}$$ is the energy of pristine supercell. The {110}\textless 111\textgreater slip system of BCC metals/alloys has the lowest energy barrier for activation. Therefore, we have chosen the same slip system in present study.
...
The BCC crystal structure has 3 slip systems, $$\textless 111\textgreater\{110\}$$, $$\textless 111\textgreater\{112\}$$, and $$\textless 111\textgreater\{123\}$$. Out of these 3 slip systems, the most acitve slip system in BCC crystals is $$\textless 111\textgreater\{110\}$$. Rest 2 slip systems get activate at high temperature as the planes $$\{112\}$$ and $$\{123\}$$ are not as closed-packed as $$\{110\}$$. Majority of the deformation in BCC crystal occurs due the dislocation slip on $$\textless 111\textgreater\{110\}$$ slip system. Therefore, we have focused on the $$\gamma_{usfe}$$ of the $$\textless 111\textgreater\{110\}$$ and the $$\gamma_{s}$$ of $$\{110\}$$ plane. The intrinsic ductility parameter (D) has also been calculated for the same slip system.
